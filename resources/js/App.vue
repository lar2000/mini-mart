				...
				<div class="main-sidemenu">
					...
					<ul class="side-menu">
						<li class="side-item side-item-category">ເມນູຫຼັກ</li>
                            ...
                            <li class="slide"> <router-link to="/"></router-link>
                        ...
                        <li class="slide">
                            <router-link class="side-menu__item" to="/report"><span class="side-menu__label">ການເຄື່ອນໄຫວ</span></router-link>
                        </li>
                        <li class="slide">
                            <router-link class="side-menu__item" to="/transection"><span class="side-menu__label">ລາຍງານ</span></router-link>
                        </li>
